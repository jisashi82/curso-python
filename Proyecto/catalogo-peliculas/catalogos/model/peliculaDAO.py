...
def guardar(pelicula:Pelicula):
    ...
    try:
        ...
        messagebox.showerror('Conexion a la Tabla', 'La tabla peliculas no esta creada')
...
def listar():
    ...
    try:
        ...
        messagebox.showerror('Conexion', 'No existe la tabla para recuperar registros')
...
def editar(pelicula, id_pelicula):
    ...
    try:
        ...
        conexion.cerrar()
         ...
         messagebox.showerror('Conexion', 'No se ha podido editar el registro')
...
def eliminar(id_pelicula):
    ...
    try:
        ...
        messagebox.showerror('Borrando..', 'No se ha podido borrar el registro: ' +e.__str__())